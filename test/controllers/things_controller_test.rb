...
class ThingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create thing" do
    assert_difference('Thing.count') do
      post things_url, params: { thing: { description: @thing.description, image_url: @thing.image_url, name: @thing.name, thing_url: @thing.thing_url } }
    end
  ...
  test "should update thing" do
    patch thing_url(@thing), params: { thing: { description: @thing.description, image_url: @thing.image_url, name: @thing.name, thing_url: @thing.thing_url } }
